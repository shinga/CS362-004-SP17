...
int p_adventurer(struct gameState *state, int currentPlayer)
{
    ...
    while(drawntreasure<2){
        // if (state->deckCount[currentPlayer] <1){//if the deck is empty we need to shuffle discard and add to deck
            // shuffle(currentPlayer, state); // BUG HERE
        // }
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card )
    {
    case adventurer:
        return p_adventurer(state, currentPlayer);
    ...
    case mine:
        return p_mine(state, currentPlayer, handPos, choice1, choice2);
    ...
    case smithy:
        return p_smithy(state, currentPlayer, handPos);

    case village:
        return p_village(state, currentPlayer, handPos);
    ...
    case great_hall:
        return p_great_hall(state, currentPlayer, handPos);


    case minion:
        return p_minion(state, currentPlayer, handPos, choice1, choice2);
